...
### Added
- **Correction evals:** `evals/v171-correction-evals.json` covers the facts corrected in this release: the Rich traceback installer, lazygit and k9s config formats, Ctrl+S flow control, btop's single refresh rate, Wish v2 session options, and the spinner delay contract.
